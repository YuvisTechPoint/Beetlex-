...
const coreMockEvents: Event[] = [
  {
    ...
    prizes: [
      { trackId: 'evt-upcoming-1-track-ai', rank: 1, amount: 10000, currency: 'USD', perks: ['$5K cloud credits', 'Mentorship with OpenAI engineers'] },
      { trackId: 'evt-upcoming-1-track-ai', rank: 2, amount: 5000, currency: 'USD', perks: ['$2K cloud credits', 'Swag kit'] },
      { trackId: 'evt-upcoming-1-track-ml', rank: 1, amount: 8000, currency: 'USD', perks: ['NVIDIA Jetson kit', 'Edge AI workshop'] },
      { trackId: 'evt-upcoming-1-track-devtools', rank: 1, amount: 7500, currency: 'USD', perks: ['DevTools Inc. internship interview'] },
      { trackId: 'evt-upcoming-1-track-web3', rank: 1, amount: 6000, currency: 'USD', perks: ['ChainLabs grant application support'] },
    ],
    sponsors: createBeetlexSponsors('sp-up1'),
    timeline: [
      { date: '2026-07-01T00:00:00.000Z', label: 'Registration Opens', description: 'Team registration and track selection begin on the BeetleX platform.' },
      { date: '2026-08-15T23:59:59.000Z', label: 'Registration Closes', description: 'Final deadline to register teams and confirm track assignments.' },
      { date: '2026-08-22T09:00:00.000Z', label: 'Kickoff & Team Formation', description: 'Opening ceremony, keynote from AI industry leaders, and final team sync.' },
      { date: '2026-08-24T09:00:00.000Z', label: 'Submission Deadline', description: 'All project repos, demos, and pitch decks must be submitted.' },
      { date: '2026-08-25T10:00:00.000Z', label: 'Judging Round', description: 'Live demos and Q&A sessions with the judging panel.' },
      { date: '2026-08-26T18:00:00.000Z', label: 'Awards Ceremony', description: 'Winners announced across all tracks. Networking reception follows.' },
    ],
    ...
    faqs: [
      ...
      { question: 'Can we switch tracks after registering?', answer: 'Track changes are allowed until registration closes on August 15, 2026.' },
      { question: 'What format should submissions take?', answer: 'GitHub repo (public or private with judge access), 3-minute demo video, and a live deployable demo URL.' },
    ],
  ...
  },
  {
    ...
    tracks: [
      {
        ...
        description: 'Build decentralized finance protocols with novel tokenomics or yield mechanisms.',
        problemStatement:
    ...
    prizes: [
      { trackId: 'evt-upcoming-2-track-web3', rank: 1, amount: 12000, currency: 'USD', perks: ['CertiK audit voucher', 'ETHGlobal finalist slot'] },
      { trackId: 'evt-upcoming-2-track-web3', rank: 2, amount: 6000, currency: 'USD', perks: ['Alchemy Plus subscription'] },
      { trackId: 'evt-upcoming-2-track-ai', rank: 1, amount: 8000, currency: 'USD', perks: ['Chainlink grant referral'] },
      { trackId: 'evt-upcoming-2-track-devtools', rank: 1, amount: 7000, currency: 'USD', perks: ['Foundry team mentorship'] },
    ],
    ...
    timeline: [
      { date: '2026-08-01T00:00:00.000Z', label: 'Registration Opens', description: 'Sign up and claim testnet faucet credits from sponsors.' },
      { date: '2026-09-10T23:59:59.000Z', label: 'Registration Closes', description: 'Last day to register teams and select tracks.' },
      { date: '2026-09-19T08:00:00.000Z', label: 'Hackathon Begins', description: 'Opening keynote on Web3 security and team hacking starts.' },
      { date: '2026-09-20T20:00:00.000Z', label: 'Submission Deadline', description: 'Submit repos, contract addresses, and demo videos.' },
      { date: '2026-09-21T09:00:00.000Z', label: 'Judging', description: 'Technical review and live contract demos.' },
      { date: '2026-09-21T17:00:00.000Z', label: 'Results', description: 'Winners announced and sponsor networking session.' },
    ],
    ...
    teamMaxSize: 5,
    faqs: [
      { question: 'Which chains are supported?', answer: 'Ethereum Sepolia, Polygon Amoy, and Solana Devnet. Deploy on at least one.' },
      { question: 'Are audit tools provided?', answer: 'Yes. CertiK and Slither integrations are available in the starter kit.' },
      { question: 'Can we use existing smart contract templates?', answer: 'OpenZeppelin and Solmate libraries are allowed. Custom logic must be original.' },
      { question: 'Is KYC required?', answer: 'No KYC for participation. Prize disbursement may require identity verification.' },
      { question: 'How are gas costs covered?', answer: 'Each team receives testnet ETH/MATIC/SOL from sponsor faucets upon registration.' },
      { question: 'What if our contract has a bug?', answer: 'Testnet-only deployments are expected. Document known limitations in your README.' },
    ],
  ...
  },
  {
    ...
    tracks: [
      ...
      },
      {
        ...
        description: 'Build tools for monitoring, profiling, and optimizing application performance.',
        problemStatement:
    ...
    prizes: [
      { trackId: 'evt-active-1-track-devtools', rank: 1, amount: 15000, currency: 'USD', perks: ['GitHub Stars feature', 'DevTools Inc. acquisition talk'] },
      { trackId: 'evt-active-1-track-devtools', rank: 2, amount: 7500, currency: 'USD', perks: ['JetBrains license bundle'] },
      { trackId: 'evt-active-1-track-ai', rank: 1, amount: 12000, currency: 'USD', perks: ['YC office hours'] },
      { trackId: 'evt-active-1-track-ml', rank: 1, amount: 10000, currency: 'USD', perks: ['Datadog pro credits'] },
      { trackId: 'evt-active-1-track-web3', rank: 1, amount: 8000, currency: 'USD', perks: ['Foundry pro license'] },
    ],
    sponsors: pickShowcaseSponsors(
      [
    ...
    timeline: [
      { date: '2026-05-01T00:00:00.000Z', label: 'Registration Opens', description: 'Early bird registration with bonus office hour slots.' },
      { date: '2026-06-01T23:59:59.000Z', label: 'Registration Closes', description: 'Final team roster lock.' },
      { date: '2026-06-10T00:00:00.000Z', label: 'Hacking Begins', description: '72-hour countdown starts. Discord channels go live.' },
      { date: '2026-06-13T00:00:00.000Z', label: 'Submission Deadline', description: 'Repos, install guides, and demo videos due.' },
      { date: '2026-06-14T10:00:00.000Z', label: 'Judging', description: 'Judges clone repos and score live demos.' },
      { date: '2026-06-15T16:00:00.000Z', label: 'Results', description: 'Winners announced on live stream.' },
    ],
    ...
    teamMaxSize: 4,
    faqs: [
      { question: 'Can we submit a CLI tool?', answer: 'Absolutely. CLI, IDE extensions, web dashboards, and libraries are all valid.' },
      { question: 'Is there a language restriction?', answer: 'No. Use any language. Provide clear install and run instructions.' },
      { question: 'How does live judging work?', answer: 'Judges run your install steps on a clean VM. If it fails, you get one 15-minute fix window.' },
      { question: 'Are private repos allowed?', answer: 'Yes until submission. Make public or grant judge access before the deadline.' },
      { question: 'Can we continue after the hackathon?', answer: 'Yes. Winning projects are encouraged to open-source and maintain post-event.' },
      { question: 'What is the scoring criteria?', answer: 'Innovation (25%), technical execution (30%), developer impact (25%), presentation (20%).' },
    ],
  ...
  },
  {
    ...
    tracks: [
      ...
      },
      {
        ...
        description: 'Predictive models for climate risk, energy optimization, and carbon tracking.',
        problemStatement:
    ...
    prizes: [
      { trackId: 'evt-active-2-track-ai', rank: 1, amount: 20000, currency: 'USD', perks: ['WHO innovation lab pilot', 'Publication support'] },
      { trackId: 'evt-active-2-track-ml', rank: 1, amount: 15000, currency: 'USD', perks: ['Climate tech accelerator intro'] },
      { trackId: 'evt-active-2-track-devtools', rank: 1, amount: 10000, currency: 'USD', perks: ['NGO deployment grant'] },
    ],
    sponsors: pickShowcaseSponsors(
      [
    ...
    timeline: [
      { date: '2026-05-15T00:00:00.000Z', label: 'Registration Opens', description: 'Dataset access granted upon team confirmation.' },
      { date: '2026-06-05T23:59:59.000Z', label: 'Registration Closes', description: 'Team and track lock.' },
      { date: '2026-06-08T06:00:00.000Z', label: 'Hackathon Starts', description: 'Dataset release and ethics briefing.' },
      { date: '2026-06-10T06:00:00.000Z', label: 'Submissions Due', description: 'Model weights, notebooks, and impact report submitted.' },
      { date: '2026-06-11T08:00:00.000Z', label: 'Judging', description: 'Technical and ethics panel review.' },
      { date: '2026-06-12T14:00:00.000Z', label: 'Awards', description: 'Winners announced with NGO partner presentations.' },
    ],
    ...
    teamMaxSize: 5,
    faqs: [
      { question: 'Are datasets HIPAA compliant?', answer: 'Healthcare datasets are de-identified and approved for research use only.' },
      { question: 'Must models be explainable?', answer: 'Yes. All healthcare track submissions require saliency maps or SHAP values.' },
      { question: 'Can we use pre-trained models?', answer: 'Fine-tuning pre-trained models is allowed. Document the base model and training procedure.' },
      { question: 'Is GPU access provided?', answer: 'Kaggle kernels and GCP credits are available to all registered teams.' },
      { question: 'What is the impact report?', answer: 'A 2-page document describing potential real-world deployment and ethical considerations.' },
      { question: 'Can NGOs adopt our project?', answer: 'Winning teams receive introductions to partner NGOs for pilot deployments.' },
    ],
  ...
  },
  {
    ...
    prizes: [
      { trackId: 'evt-closed-1-track-ai', rank: 1, amount: 10000, currency: 'USD', perks: ['IBM Quantum researcher mentorship'] },
      { trackId: 'evt-closed-1-track-ml', rank: 1, amount: 8000, currency: 'USD', perks: ['AWS Braket credits'] },
      { trackId: 'evt-closed-1-track-devtools', rank: 1, amount: 6000, currency: 'USD', perks: ['Qiskit contributor badge'] },
      { trackId: 'evt-closed-1-track-web3', rank: 1, amount: 5000, currency: 'USD', perks: ['NIST PQC workshop invite'] },
    ],
    sponsors: pickShowcaseSponsors(
      [
        { name: 'NVIDIA', tier: 'platinum' },
    ...
    timeline: [
      { date: '2025-09-01T00:00:00.000Z', label: 'Registration Opens', description: 'Quantum fundamentals workshop series begins.' },
      { date: '2025-10-15T23:59:59.000Z', label: 'Registration Closes', description: 'Final team confirmation.' },
      { date: '2025-10-25T08:00:00.000Z', label: 'Hackathon Begins', description: 'IBM Quantum and Braket credits distributed.' },
      { date: '2025-10-27T08:00:00.000Z', label: 'Submissions Due', description: 'Notebooks and circuit diagrams submitted.' },
      { date: '2025-10-28T10:00:00.000Z', label: 'Judging', description: 'Expert panel reviews quantum advantage claims.' },
      { date: '2025-10-29T15:00:00.000Z', label: 'Awards', description: 'Winners presented at closing ceremony.' },
    ],
    ...
    teamMaxSize: 4,
    faqs: [
      { question: 'Do I need quantum hardware access?', answer: 'Simulators were sufficient. Hardware access was optional via IBM and AWS credits.' },
      { question: 'What background is required?', answer: 'Linear algebra and basic Python. Pre-event workshops covered quantum fundamentals.' },
      { question: 'Could teams use PennyLane?', answer: 'Yes. Qiskit, Cirq, PennyLane, and Braket SDKs were all supported.' },
      { question: 'How were results verified?', answer: 'Judges re-ran notebooks on provided infrastructure to verify claims.' },
      { question: 'Were there qubit limits?', answer: 'Simulator shots unlimited. Hardware jobs capped at 1000 shots per team.' },
      { question: 'Is this event recurring?', answer: 'Quantum Leap 2026 is planned for Q4 2026. Join the mailing list for updates.' },
    ],
  ...
  },
  {
    ...
    tracks: [
      {
        ...
        description: 'ML models for emissions tracking, forecasting, and reduction recommendations.',
        problemStatement:
      ...
      },
      {
        ...
        description: 'AI systems for parsing climate policy documents and surfacing actionable insights.',
        problemStatement:
    ...
    prizes: [
      { trackId: 'evt-closed-2-track-ml', rank: 1, amount: 12000, currency: 'USD', perks: ['Cleantech VC pitch day'] },
      { trackId: 'evt-closed-2-track-web3', rank: 1, amount: 10000, currency: 'USD', perks: ['Toucan Protocol integration support'] },
      { trackId: 'evt-closed-2-track-devtools', rank: 1, amount: 8000, currency: 'USD', perks: ['Green Software Foundation membership'] },
      { trackId: 'evt-closed-2-track-ai', rank: 1, amount: 8000, currency: 'USD', perks: ['UNEP pilot program intro'] },
    ],
    sponsors: pickShowcaseSponsors(
      [
        { name: 'Polygon', tier: 'platinum' },
    ...
    timeline: [
      { date: '2025-03-01T00:00:00.000Z', label: 'Registration Opens', description: 'Climate tech primer workshops available.' },
      { date: '2025-04-10T23:59:59.000Z', label: 'Registration Closes', description: 'Team lock and impact metric training.' },
      { date: '2025-04-18T07:00:00.000Z', label: 'Hackathon Starts', description: 'Mentor matching and dataset release.' },
      { date: '2025-04-20T07:00:00.000Z', label: 'Submissions Due', description: 'Projects with impact calculators submitted.' },
      { date: '2025-04-21T09:00:00.000Z', label: 'Judging', description: 'Impact and technical panels review submissions.' },
      { date: '2025-04-22T16:00:00.000Z', label: 'Awards & Fundraising', description: 'Winners announced. VC office hours for top 20 teams.' },
    ],
    ...
    teamMaxSize: 5,
    faqs: [
      { question: 'How was environmental impact measured?', answer: 'Teams used our impact calculator template with kg CO2e, water, and waste metrics.' },
      { question: 'Were carbon offsets provided?', answer: 'The event itself was carbon-neutral via Patch offsets. Projects did not need offsets.' },
      { question: 'Could we use proprietary company data?', answer: 'Only with written permission. Public datasets were recommended.' },
      { question: 'What happened to winning projects?', answer: '12 teams received seed funding intros. 8 projects continued as open-source.' },
      { question: 'Was Web3 required for the green DeFi track?', answer: 'Smart contracts were required for that track only. Other tracks had no blockchain requirement.' },
      { question: 'Will GreenStack return?', answer: 'GreenStack 2026 is scheduled for Earth Day week. Watch beetlex.io for announcements.' },
    ],
